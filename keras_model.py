...
def get_model(data_in, data_out, dropout_rate, nb_cnn2d_filt, pool_size,
    ...
    if loader:
        model = load_model('C:/Users/shalea2/PycharmProjects/Drones/models/ansim_ov3_split1_regr0_3d0_1_model.h5', custom_objects=SeqSelfAttention.get_custom_objects())
