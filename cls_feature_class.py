...
class FeatureClass:
    def __init__(self, dataset='mreal', ov=3, split=1, nfft=1024, db=30, wav_extra_name='', desc_extra_name=''):
        ...
        if dataset == 'ansim':
            self._base_folder = os.path.join('C:/Users/shalea2/PycharmProjects/Drones/data/', 'Ansim/')
        elif dataset == 'resim':
            self._base_folder = os.path.join('C:/Users/shalea2/PycharmProjects/Drones/data/', 'Resim/')
        elif dataset == 'real':
            self._base_folder = os.path.join('C:/Users/shalea2/PycharmProjects/Drones/data/', 'Real/')
        elif dataset == 'mansim':
            self._base_folder = os.path.join('C:/Users/shalea2/PycharmProjects/Drones/data/', 'Mansim/')
        elif dataset == 'mreal':
            self._base_folder = os.path.join('C:/Users/shalea2/PycharmProjects/Drones/data/', 'Mreal/')
