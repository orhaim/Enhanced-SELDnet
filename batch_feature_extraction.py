...
dataset_name = 'mreal'  # Datasets: ansim, resim, cansim, cresim, real, mansim and mreal

# Extracts feature and labels for all overlap and splits
for ovo in [3]:  # SE overlap. Change to [1] if you are only calculating the features for overlap 1.
